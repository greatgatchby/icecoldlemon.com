                ...
                <Container fluid>
                    <Row className={'w-100'}>
                        ...
                        <Col className={'d-lg-none d-flex justify-content-end'}>
                            <a href={'https://www.fiverr.com/share/7WQXv1'}>
                                <Col>
                                    <Button className={'btn btn-primary btn-header px-5 me-2'}>Login</Button>
                                </Col>
                            </a>
                            <CartIcon />
                        </Col>
                        ...
                        <Nav className="w-100">
                            ...
                            <a href={'https://www.fiverr.com/share/7WQXv1'}  className={'d-none d-lg-block'}>
                                <Col>
                                    <Button className={'btn btn-primary btn-header px-5 me-2'}>Login</Button>
                                </Col>
                            </a>
